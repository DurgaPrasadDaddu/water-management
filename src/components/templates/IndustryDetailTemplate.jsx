...
const IconChevronRight = (p) => <Svg {...p}><path d="M9 18l6-6-6-6" /></Svg>;
const IconArrowRight   = (p) => <Svg {...p}><path d="M5 12h14M12 5l7 7-7 7" /></Svg>;
const IconAlert        = (p) => <Svg {...p}><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></Svg>;
...
const IconDollar       = (p) => <Svg {...p}><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></Svg>;
const IconLeaf         = (p) => <Svg {...p}><path d="M17 8C8 10 5.9 16.17 3.82 19.34L5 21l2-1c2.54-.5 9-3 11.5-7.5C21 9 19 7 17 8z" /></Svg>;
const IconDroplets     = (p) => <Svg {...p}><path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z"/><path d="M12.56 6.6A10.97 10.97 0 0014 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 01-11.91 4.97"/></Svg>;
const IconSearch       = (p) => <Svg {...p}><circle cx="11" cy="11" r="7"/><line x1="16.5" y1="16.5" x2="22" y2="22"/></Svg>;
const IconCog          = (p) => <Svg {...p}><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></Svg>;
const IconZap          = (p) => <Svg {...p}><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /></Svg>;
const IconPhone        = (p) => <Svg {...p}><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.87a19.79 19.79 0 01-3.07-8.67A2 2 0 012 .84h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></Svg>;
const IconMail         = (p) => <Svg {...p}><path d="M4 4h16c1.1 0 2 .9 2 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></Svg>;
...
const SEGMENT = {
  industrial: { badge: "Industrial Sector", dot: "bg-orange-500", pill: "bg-orange-50 text-orange-700 border-orange-200" },
  commercial: { badge: "Commercial Sector", dot: "bg-[#8DC63F]",  pill: "bg-green-50  text-green-700  border-green-200"  },
  government: { badge: "Government Sector", dot: "bg-violet-600", pill: "bg-violet-50 text-violet-700 border-violet-200" },
};
...
const STEPS = [
  { no: "01", title: "Analysis",       Icon: IconSearch, iconBg: "bg-[#00A3E0]", cardBorder: "border-blue-100",   cardHover: "hover:border-[#00A3E0]/40",  text: "text-[#00A3E0]",  barBg: "bg-[#00A3E0]",  desc: "Deep-dive audit of your infrastructure, effluent characteristics, and regulatory landscape." },
  { no: "02", title: "Design",         Icon: IconCog,    iconBg: "bg-violet-500", cardBorder: "border-violet-100", cardHover: "hover:border-violet-400/40", text: "text-violet-600", barBg: "bg-violet-500", desc: "Bespoke system architecture — sizing equipment, selecting chemistry, and modelling flow." },
  { no: "03", title: "Implementation", Icon: IconZap,    iconBg: "bg-amber-500",  cardBorder: "border-amber-100",  cardHover: "hover:border-amber-400/40",  text: "text-amber-600",  barBg: "bg-amber-500",  desc: "On-site commissioning by certified project engineers with zero compromise on quality." },
  { no: "04", title: "Optimization",   Icon: IconShield, iconBg: "bg-[#8DC63F]",  cardBorder: "border-green-100",  cardHover: "hover:border-[#8DC63F]/40",  text: "text-[#5a8a1a]",  barBg: "bg-[#8DC63F]",  desc: "Post-commissioning monitoring, SCADA integration, and continuous process tuning." },
];
...
const BENEFITS = [
  { Icon: IconShield,   title: "Regulatory Compliance", desc: "Meet CPCB, SPCB & international discharge standards confidently.",             iconBg: "bg-blue-50",   iconColor: "text-[#00A3E0]", border: "border-blue-100"  },
  { Icon: IconDollar,   title: "Cost Reduction",         desc: "Lower OPEX through energy-efficient design and intelligent automation.",        iconBg: "bg-green-50",  iconColor: "text-[#5a8a1a]", border: "border-green-100" },
  { Icon: IconDroplets, title: "Water Reuse",             desc: "Recover and recycle treated water for secondary industrial processes.",         iconBg: "bg-sky-50",    iconColor: "text-sky-600",   border: "border-sky-100"   },
  { Icon: IconLeaf,     title: "Sustainability Goals",    desc: "Align ESG commitments with ZLD mandates and greener operational footprints.",   iconBg: "bg-lime-50",   iconColor: "text-[#8DC63F]", border: "border-lime-100"  },
];
...
const SectionLabel = ({ text }) => (
  <div className="flex items-center justify-center gap-2 mb-4">
    ...
    <span style={{ fontFamily: "var(--font-poppins)", letterSpacing: "0.22em" }}
      className="text-[#00A3E0] text-xs font-bold uppercase">{text}</span>
  </div>
);
...
export default function IndustryDetailsTemplate({ segment = "industrial", industry }) {
  const [tab, setTab] = useState("problems");
  const seg = SEGMENT[segment] || SEGMENT.industrial;

  if (!industry) return null;
  const { name = "Industry", image, shortDescription = "", description = "",
    problems = [], solutions = [], relatedSolutions = [], relatedServices = [] } = industry;

  const str = (v) => (typeof v === "string" ? v : v?.title || v?.text || "");

  return (
    <div style={{ fontFamily: "var(--font-inter)", color: "var(--color-text)", background: "var(--color-white)" }}
      ...
      <section className="relative min-h-[78vh] flex items-end overflow-hidden">
        ...
        <div className="absolute top-14 right-14 hidden lg:grid grid-cols-7 gap-3 opacity-[0.08]" aria-hidden="true">
        ...
        <div className="relative z-10 w-full container-custom pb-16 lg:pb-24 pt-36">
          ...
          {/* Sector badge */}
          <span className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest border mb-6 ${seg.pill}`}>
            <span className={`w-1.5 h-1.5 rounded-full ${seg.dot}`} />
            {seg.badge}
          </span>

          {/* Heading */}
          <h1 style={{ fontFamily: "var(--font-poppins)" }}
            className="text-5xl sm:text-6xl lg:text-[4.5rem] font-bold text-white leading-[1.1] mb-5 max-w-4xl">
            {name}
            <span className="block text-[#00A3E0] mt-2">Treatment Solutions</span>
          </h1>
            ...
            {[
              ...
              <div key={s.l}>
                <div style={{ fontFamily: "var(--font-poppins)" }}
                  className="text-[#00A3E0] text-2xl font-bold">{s.v}</div>
                <div className="text-white/45 text-xs uppercase tracking-widest mt-0.5">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative group order-2 lg:order-1">
              ...
              <div className="relative z-10 rounded-[16px] overflow-hidden aspect-[4/3] bg-gray-100 shadow-xl">
                {image && (
                  <Image src={image} alt={`${name} overview`} fill
                ...
                <div className="absolute bottom-5 left-5">
                  <div className="inline-flex items-center gap-2 bg-white/96 backdrop-blur-sm border border-gray-200 shadow-lg rounded-xl px-4 py-2.5">
                    ...
                    <span style={{ fontFamily: "var(--font-poppins)" }}
                      className="text-sm text-[#1F2937] font-semibold">ISO-Certified Engineering</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="flex items-center gap-8">
                <Link href="#approach"
                  ...
                  Our Approach <IconArrowRight size={15} className="group-hover:translate-x-1 transition-transform duration-200" />
                </Link>
                <Link href="/services"
                  ...
                  All Services <IconArrowRight size={15} className="group-hover:translate-x-1 transition-transform duration-200" />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="container-custom">
            ...
            <div className="text-center mb-14">
              ...
              <h2 style={{ fontFamily: "var(--font-poppins)" }}
                ...
                Challenges We{" "}
                <span className="text-red-500">Identify</span>
                {" & "}
                <span className="text-[#00A3E0]">Solve</span>
              </h2>
              <p className="text-[#4B5563] max-w-2xl mx-auto text-lg leading-relaxed">
                Every industry faces unique environmental and process challenges.
                Our engineers translate those pain points into compliant, bankable outcomes.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 style={{ fontFamily: "var(--font-poppins)" }}
                      className="font-bold text-[#1F2937] text-lg">Industry Challenges</h3>
                    <p className="text-gray-400 text-xs">What your sector faces</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {problems.map((p, i) => (
                    <div key={i}
                      ...
                      <p className="text-[#4B5563] text-sm leading-[1.7]">{str(p)}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className={tab === "problems" ? "hidden lg:block" : ""}>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 style={{ fontFamily: "var(--font-poppins)" }}
                      className="font-bold text-[#1F2937] text-lg">Our Engineering Solutions</h3>
                    <p className="text-gray-400 text-xs">How Hyaline delivers results</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {solutions.map((s, i) => (
                    <div key={i}
                      ...
                      <p className="text-[#4B5563] text-sm leading-[1.7]">{str(s)}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="mt-12 relative overflow-hidden rounded-[16px] bg-gradient-to-r from-[#00A3E0] to-[#0284C7] p-8 shadow-xl shadow-[#00A3E0]/20">
              ...
              <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-6">
                <div className="flex-1">
                  <h4 style={{ fontFamily: "var(--font-poppins)" }}
                    className="text-xl font-bold text-white mb-1">
                    From Compliance Risk → Engineering Excellence
                  </h4>
                  <p className="text-white/75 text-sm leading-relaxed">
                    Every challenge you face has an engineered answer. Let us show you how.
                  </p>
                </div>
                <Link href="/contact"
        ...
        <div className="container-custom">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-[#4B5563] max-w-2xl mx-auto text-lg">
              A structured four-phase methodology guaranteeing technical precision
              and regulatory compliance at every stage.
            </p>
          </div>
            ...
            {STEPS.map((s) => {
              ...
              return (
                <div key={s.no}
                  ...
                  {/* Icon */}
                  <div className={`relative z-10 inline-flex p-3.5 ${s.iconBg} rounded-[10px] mb-6 shadow-md`}>
                    <StepIcon size={20} className="text-white" />
                  </div>
                  <h3 style={{ fontFamily: "var(--font-poppins)" }}
                    className={`text-lg font-bold mb-3 ${s.text}`}>{s.title}</h3>
                  <p className="text-[#4B5563] text-sm leading-[1.7]">{s.desc}</p>
                  {/* Bottom accent bar */}
                  <div className={`absolute bottom-0 left-0 h-0.5 w-0 group-hover:w-full ${s.barBg} transition-all duration-500`} />
                </div>
              );
            })}
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-[#4B5563] max-w-xl mx-auto text-lg">
              Measurable outcomes impacting your bottom line, compliance posture, and sustainability targets.
            </p>
          </div>
            ...
            {BENEFITS.map((b, i) => {
              ...
              return (
                <div key={i}
                  ...
                  <div className={`inline-flex p-4 ${b.iconBg} rounded-[10px] mb-5 border ${b.border} group-hover:scale-110 transition-transform duration-300`}>
                    <BIcon size={22} className={b.iconColor} />
                  </div>
                  <h3 style={{ fontFamily: "var(--font-poppins)" }}
                    className="text-base font-bold text-[#1F2937] mb-3">{b.title}</h3>
                  <p className="text-[#4B5563] text-sm leading-[1.7]">{b.desc}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="relative overflow-hidden rounded-[16px] bg-gradient-to-br from-[#1F2937] via-[#0f2d42] to-[#1F2937] px-10 py-16 lg:px-20 lg:py-20 text-center shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/65 text-lg max-w-2xl mx-auto mb-10 leading-[1.75]">
                Our engineers specialise in compliance-ready, cost-effective treatment systems
                tailored precisely to your operational requirements. Let is design yours.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                <Link href="/contact"
                  ...
                  Get a Quote
                  <IconArrowRight size={17} className="group-hover:translate-x-1 transition-transform duration-200" />
                </Link>
                <Link href="tel:+917942818686"
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 pt-8 border-t border-white/10">
                {["✅ No commitment required", "⚡ Response within 24 hrs", "🔒 Confidential assessment", "🏆 ISO-certified engineers"].map(t => (
                  <span key={t} className="text-white/45 text-sm">{t}</span>
                ))}
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-6 mt-8">
                ...
                <a href="mailto:info@hyalineenviro.com"
                  className="inline-flex items-center gap-2 text-white/45 hover:text-[#00A3E0] text-sm transition-colors duration-200">
