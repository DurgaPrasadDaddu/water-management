...
//       {/* ================= CURVED BACKGROUND ================= */}
//       <div className="relative bg-[#61c7e0] pt-10 pb-36">
//         {/* Curve Shape */}
...
//             <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mt-4 text-[color:var(--color-dark)] leading-tight">
...
//         {/* ================= BOTTOM TEXT ================= */}
//         <div className="text-center m-12 text-base sm:text-lg
